...
var MerchantPortalAuthenticator = /*#__PURE__*/function () {
  ...
  return _createClass(MerchantPortalAuthenticator, null, [{
    ...
    key: "setMerchantKYC",
    value: function setMerchantKYC(appKey, token) {
    ...
    value: function () {
      var _login = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref) {
        var onSuccess, onError, appKey, iframe, connectionTimeout;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              onSuccess = _ref.onSuccess, onError = _ref.onError, appKey = _ref.appKey;
              ...
              window.addEventListener("message", function (event) {
                var _event$data, _event$data3;
                if (((_event$data = event.data) === null || _event$data === void 0 || (_event$data = _event$data.loginResponse) === null || _event$data === void 0 ? void 0 : _event$data.responseCode) === "0" && onSuccess) {
                  var _event$data2;
                  onSuccess({
                    token: (_event$data2 = event.data) === null || _event$data2 === void 0 || (_event$data2 = _event$data2.loginResponse) === null || _event$data2 === void 0 || (_event$data2 = _event$data2.data) === null || _event$data2 === void 0 ? void 0 : _event$data2.token
                  });
                } else if ((_event$data3 = event.data) !== null && _event$data3 !== void 0 && (_event$data3 = _event$data3.loginError) !== null && _event$data3 !== void 0 && _event$data3.error && onError) {
                  onError({
                  ...
                  var _event$data4;
                  onError({
                    message: (_event$data4 = event.data) === null || _event$data4 === void 0 || (_event$data4 = _event$data4.loginResponse) === null || _event$data4 === void 0 ? void 0 : _event$data4.responseMessage
                  });
                }
              });
            case 12:
            ...
            case 0:
              ...
              window.addEventListener("message", /*#__PURE__*/function () {
                var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event) {
                  var _event$data5;
                  var _event$data6, _event$data8, _event$data7;
                  return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                    while (1) switch (_context2.prev = _context2.next) {
                      case 0:
                        if (((_event$data5 = event.data) === null || _event$data5 === void 0 ? void 0 : _event$data5.type) === "token") {
                          if (onSuccess && (_event$data6 = event.data) !== null && _event$data6 !== void 0 && _event$data6.token) {
                            onSuccess((_event$data7 = event.data) === null || _event$data7 === void 0 ? void 0 : _event$data7.token);
                          } else if (onError && !((_event$data8 = event.data) !== null && _event$data8 !== void 0 && _event$data8.token)) {
                            onError({
...
window.addEventListener("message", function (event) {
  var _event$data9;
  if (((_event$data9 = event.data) === null || _event$data9 === void 0 ? void 0 : _event$data9.type) === "closeIframe") {
    MerchantPortalAuthenticator.closeIframe();
  }
});
window.MerchantPortalAuthenticator = MerchantPortalAuthenticator;